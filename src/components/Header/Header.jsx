...
function Header({ headerBg }) {
    ...
    return (
        <header className={`Header header__${headerBg}`}>
            <div className='Header__Inner'>
                ...
                <button className='button-toggler' onClick={() => setHideMenu(!hideMenu)}>
                    {hideMenu ? <svg className="menu-toggler" fill="black" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path d="M24 6h-24v-4h24v4zm0 4h-24v4h24v-4zm0 8h-24v4h24v-4z" />
                    </svg> : <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="2.10043" y1="19.0711" x2="19.5858" y2="1.58579" stroke="black" stroke-width="4" />
                        <line x1="2.41421" y1="1.58579" x2="19.3848" y2="18.5563" stroke="black" stroke-width="4" />
                    </svg>}
                </button>

                <nav className={(hideMenu ? 'Header__Inner__Nav' : ' active')}>
                    <ul className='Header__Inner__Nav__Lists'>
                        <li className='Header__Inner__Nav__Lists__List'>
                            <Link className='Header__Inner__Nav__Lists__List__Link' to="/project">{t('project.1')}</Link>
                        </li>

                        <li className='Header__Inner__Nav__Lists__List'>
                            <Link className='Header__Inner__Nav__Lists__List__Link' to="/contacts">{t('contacts.1')}</Link>
                        </li>

                        <li className='Header__Inner__Nav__Lists__List'>
                            <Link className='Header__Inner__Nav__Lists__List__Link' to="/login">{t('signin.1')}</Link>
                        </li>

                        <li className='Header__Inner__Nav__Lists__List'>
                            <Link className='Header__Inner__Nav__Lists__List__Link' to="/signup">{t('signup.1')}</Link>
                        </li>

                        <li className='Header__Inner__Nav__Lists__List'>
                            <a className='Header__Inner__Nav__Lists__List__Link-An' href="/">{t('announcements.1')}</a>
                        </li>

                        <li>
                            <button className='kg' onClick={() => handleClick('kg')}>
                                KG
                            </button>
                        </li>

                        <li>
                            <button className='ru' onClick={() => handleClick('ru')}>
                                RU
                            </button>
                        </li>

                        <li>
                            <button className='en' onClick={() => handleClick('en')}>
                                EN
                            </button>
                        </li>
                    </ul>
