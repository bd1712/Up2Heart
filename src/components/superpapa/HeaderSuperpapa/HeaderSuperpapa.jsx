...
function HeaderSuperpapa() {
  ...
  return (
    <header className="HeaderSuperpapa">
      <div className="container">
        <div className="HeaderSuperpapa__Inner">
          <div className="HeaderSuperpapa__Inner__Logo">
            <Link to="/">
              <svg
                width="150"
                height="50"
          ...
          <nav className="HeaderSuperpapa__Inner__Nav">
            <ul className="HeaderSuperpapa__Inner__Nav__Lists">
              <li className="HeaderSuperpapa__Inner__Nav__Lists__List">
                <Link
                  className="HeaderSuperpapa__Inner__Nav__Lists__List__Link"
                  to="/project"
                >
                  {t("project.1")}
                </Link>
              ...
              <li className="HeaderSuperpapa__Inner__Nav__Lists__List">
                <a
                  className="HeaderSuperpapa__Inner__Nav__Lists__List__Link-An"
                  to="/announcement"
                >
                  {t("announcements.1")}
                </a>
...
export default HeaderSuperpapa;
